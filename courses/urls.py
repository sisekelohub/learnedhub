from courses.views import AddComment, CourseDetail, CourseManage, CourseSearch, CourseStudy, CoursesHomeViews,CourseManageCourseList, GetCartDetail, SearchCourse, index
...
urlpatterns = [
    ...
    path('courses/',CoursesHomeViews.as_view(),),
